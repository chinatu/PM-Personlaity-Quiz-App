...
let questions = [
    ...
    },
    {
        ...
        choice1: "It\'s centered on the use and technical functionalities of a product",
        choice2: "It is centered on an enterprise specialty software. Where you have to think about market impact, scalability, type of business model etc"
...
function getNewQuestion(){
    ...
    if(availableQuestions.length === 0 || questionCounter>=MAX_QUESTIONS){
        ...
        console.log("Business Facing "+Business_Facing)
        console.log("High Abstraction" +High_Abstraction)
        console.log("Low Abstraction "+Low_Abstraction)

        let pTotal = Engineering_Facing + Business_Facing + High_Abstraction + Low_Abstraction;

        let Engineering_Facing_Per = Math.round(Engineering_Facing/pTotal * 100);
        let Business_Facing_Per = Math.round(Business_Facing/pTotal * 100);
        ...
        var xValues = ["High Abstraction "+High_Abstraction_Per+"%", "Engineering-Facing "+Engineering_Facing_Per+"%", "Business-Facing "+ Business_Facing_Per+"%", "Low Abstraction "+Low_Abstraction_Per+"%"];
        var yValues = [High_Abstraction,Engineering_Facing,Business_Facing,Low_Abstraction];
        // // var yValues = [High_Abstraction, Engineering_Facing, Business_Facing, Low_Abstraction];
        var barColors = [
        "#b91d47",
        "#00aba9",
...
var xValues = ["High Abstraction", "Engineering-Facing", "Business-Facing ", "Low Abstraction"];
var yValues = [2,1,2,2];
